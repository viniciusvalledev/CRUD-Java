...
If you want to learn more about Java development, please visit the official documentation: https://docs.oracle.com/en/java/.
...
Bash
./mvnw package
It produces the runnable .jar file in the target/ directory.
